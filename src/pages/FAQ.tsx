...
const WHATSAPP_URL = "https://wa.me/918411017676?text=Hello%20Rima%20Ma'am%2C%20I%20have%20a%20question%20about%20Vastu.";
...
const faqs = [
  ...
  { q: "Do I need to make structural changes to my home?", a: "In most cases, no. Rima Ma'am specialises in non-invasive, practical remedies that work within your existing structure. These may include furniture rearrangement, colour adjustments, placement of specific elements, and energy-balancing techniques. Structural changes are recommended only in rare cases and always as a last resort." },
  { q: "How do online consultations work?", a: "Online consultations are conducted via video call (Zoom, Google Meet, or WhatsApp). You share your floor plan and photos of your space in advance. Rima Ma'am analyses the layout, conducts the consultation via screen-sharing, and provides a detailed digital report with room-by-room recommendations. The quality and depth of the analysis is identical to an in-person visit." },
  { q: "How long does a typical consultation take?", a: "An in-person consultation for a standard residential property typically takes 2–4 hours, depending on the size and complexity of the space. Online consultations usually run 60–90 minutes. Rima Ma'am ensures every question is addressed and every room is covered — she never rushes a consultation." },
  { q: "What does 'lifetime support' mean?", a: "Lifetime support means that once you've had a consultation with Rima Ma'am, you can reach out to her at any time in the future with follow-up questions, implementation queries, or new concerns about your space — at no additional cost. It's her commitment to your ongoing well-being." },
  ...
  { q: "How much does a consultation cost?", a: "Consultation fees vary depending on the type of service (residential, commercial, online), the size of the property, and the complexity involved. Rima Ma'am offers transparent pricing with no hidden charges. For a personalised quote, please reach out via WhatsApp or the contact form." },
  { q: "Do you offer Vastu for plots and new constructions?", a: "Yes, absolutely. In fact, consulting a Vastu expert before construction begins is ideal, as it allows for the most effective integration of Vastu principles into the design. Rima Ma'am works closely with architects and builders to ensure your new space is perfectly aligned from the ground up." },
      ...
      <section className="py-20 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            Everything you need to know about Vastu and working with Rima Ma'am.
          </p>
        </div>
      </section>
