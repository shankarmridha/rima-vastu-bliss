...
const WHATSAPP_URL = "https://wa.me/918411017676?text=Hello%20Rima%20Ma'am%2C%20I%20saw%20your%20case%20studies%20and%20would%20like%20to%20discuss%20my%20project.";

const caseStudies = [
  {
    type: "3BHK Residential, Pune",
    img: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=600&h=300&fit=crop",
    ...
    intervention: "Rima Ma'am conducted a thorough Vedic Vastu analysis and recommended non-structural remedies: strategic placement of elemental corrections, colour adjustments in key rooms, and energy-balancing techniques for the entrance zone.",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1497366811353-6870744d04b2?w=600&h=300&fit=crop",
    ...
    intervention: "After a comprehensive commercial Vastu audit, Rima Ma'am recommended repositioning the CEO's cabin, adjusting the accounts department's orientation, and introducing specific remedies in the reception and conference areas.",
  ...
  },
  {
    ...
    img: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=600&h=300&fit=crop",
    ...
    intervention: "Through a detailed online consultation with floor plans and video walkthrough, Rima Ma'am identified key issues and provided a comprehensive digital report with room-by-room recommendations and easy-to-implement remedies.",
    ...
    <div>
      <section className="py-20 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground leading-tight mb-4">Case Studies</h1>
            ...
            {caseStudies.map((cs) => (
              <Card key={cs.type} className="border-primary/10 bg-card overflow-hidden flex flex-col">
                <div className="h-48 overflow-hidden">
                  <img src={cs.img} alt={cs.type} className="w-full h-full object-cover" loading="lazy" />
                </div>
                <CardContent className="p-6 flex-1 flex flex-col">
                  <h3 className="font-serif text-xl font-bold text-foreground mb-3">{cs.type}</h3>
