...
import { MessageCircle, Phone, Mail, MapPin, Languages, Instagram } from "lucide-react";
...
const WHATSAPP_URL = "https://wa.me/918411017676?text=Hello%20Rima%20Ma'am%2C%20I%20would%20like%20to%20book%20a%20consultation.";
...
const ContactPage = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    toast({
      title: "Enquiry Sent!",
      description: "Thank you for reaching out. Rima Ma'am will get back to you within 24 hours.",
    });
    ...
    <div>
      <section className="py-20 bg-gradient-to-b from-primary/5 to-transparent">
        <div className="container mx-auto px-4 text-center max-w-3xl">
          ...
          <h1 className="font-serif text-4xl md:text-5xl font-bold text-foreground leading-tight mb-4">Contact Rima Ma'am</h1>
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl mx-auto">
            ...
            <Card className="border-primary/10 bg-card">
              <CardContent className="p-8">
                <h2 className="font-serif text-2xl font-bold text-foreground mb-4">Send an Enquiry</h2>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <Input id="phone" type="tel" placeholder="+91 84110 17676" value={formData.phone} onChange={(e) => setFormData({ ...formData, phone: e.target.value })} required />
                  </div>
                  <div>
            ...
            <div className="space-y-6">
              ...
              <Card className="border-accent/30 bg-accent/5">
                <CardContent className="p-6 text-center">
                  ...
                  <p className="text-sm text-muted-foreground mb-3">For a faster response, reach us directly on WhatsApp.</p>
              ...
              <div className="space-y-3">
                <a href="tel:+918411017676" className="flex items-center gap-3 p-4 rounded-lg bg-card border border-primary/10 hover:border-primary/30 transition-colors">
                  <Phone className="w-5 h-5 text-primary" />
                  <div>
                    <p className="text-sm font-semibold">Phone</p>
                    <p className="text-sm text-muted-foreground">+91 84110 17676</p>
                  </div>
                </a>
                <a href="mailto:rima.mridha@gmail.com" className="flex items-center gap-3 p-4 rounded-lg bg-card border border-primary/10 hover:border-primary/30 transition-colors">
                  <Mail className="w-5 h-5 text-primary" />
                  <div>
                    <p className="text-sm font-semibold">Email</p>
                    <p className="text-sm text-muted-foreground">rima.mridha@gmail.com</p>
                  </div>
                </a>
                <a href="https://www.instagram.com/vastu.24/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-4 rounded-lg bg-card border border-primary/10 hover:border-primary/30 transition-colors">
                  <Instagram className="w-5 h-5 text-primary" />
                  <div>
                    <p className="text-sm font-semibold">Instagram</p>
                    <p className="text-sm text-muted-foreground">@vastu.24</p>
                  </div>
                </a>
